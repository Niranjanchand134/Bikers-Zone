...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        throw new showErrorToast('Form submission failed');
      }
    } catch (error) {
  ...
  return (
    <>
      <Header />
      <div className="max-w-[1200px] mx-auto px-3 py-8 sm:py-16 lg:px-10">
        <div className="lead container my-3 py-3">
          ...
          <p className="mb-4">
            ...
            here to help you. We welcome your feedback and criticism about BikeBazarNepal
          ...
          <ul className="marker:text-black list-disc pl-5 space-y-2 mb-4">
            ...
            <li>
              Email: <a className="text-blue-800" href="mailto:niranjachand134@gmail.com">bikerszone@gmail.com</a>
            </li>
